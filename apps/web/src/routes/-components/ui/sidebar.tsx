		...
		return (
			<Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
				...
				>
					...
					<div className="flex h-screen-safe w-full flex-col">
						{children}
						<div className="bg-sidebar w-full fixed h-1 bottom-0 z-50 left-0" />
					</div>
				</SheetContent>
			</Sheet>
		);
...
>(function SidebarMenuButton(
	...
	if (asChild && React.isValidElement(children)) {
		...
		// When asChild is true, don't wrap in tooltip to avoid nested button issues
		// Tooltips are skipped when using asChild
...
>(function SidebarMenuAction(
	{ className, render, asChild = false, showOnHover = false, children, ...props },
	forwardedRef
) {
	// When asChild is true, render as the child element
	if (asChild && React.isValidElement(children)) {
...
>(function SidebarMenuSubButton(
	{ render, asChild = false, size = "md", isActive = false, className, children, ...props },
	forwardedRef
) {
	// When asChild is true, render as the child element
	if (asChild && React.isValidElement(children)) {
