...
export const MatchResult = ({
  ...
  const { data: homeTeamAvatars } = trpc.avatar.getBySeasonPlayerIds.useQuery({
    leagueSlug,
    seasonSlug,
    seasonPlayerIds: homeTeamSeasonPlayerIds,
  });
  const { data: awayTeamAvatars } = trpc.avatar.getBySeasonPlayerIds.useQuery({
    leagueSlug,
    seasonSlug,
    seasonPlayerIds: awayTeamSeasonPlayerIds,
  });
  const { data: _homeTeam } = trpc.leagueTeam.getBySeasonPlayerIds.useQuery(
    {
      leagueSlug,
      seasonSlug,
      seasonPlayerIds: homeTeamSeasonPlayerIds,
