...
export const StrugglingCard = ({
  ...
  const { data, isLoading } = trpc.seasonPlayer.getStruggling.useQuery({ leagueSlug, seasonSlug });
...
export const OnFireCard = ({
  ...
  const { data, isLoading } = trpc.seasonPlayer.getOnFire.useQuery({ leagueSlug, seasonSlug });
