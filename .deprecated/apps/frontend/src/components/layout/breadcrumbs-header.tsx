...
export const BreadcrumbsHeader = ({
  ...
  <header className="sticky top-0 z-30 w-full grid grid-cols-2 grid-rows-1 min-h-[3.5rem] h-14 items-center gap-4 border-l-amber-50 bg-background py-2 px-4 truncate">
