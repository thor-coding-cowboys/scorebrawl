import { idConfig } from "@scorebrawl/utils/id";
...
export const Leagues = pgTable(
  "league",
  {
    id: varchar("id", idConfig).primaryKey(),
...
export const LeaguePlayers = pgTable(
  "league_player",
  {
    ...
    userId: varchar("user_id", defaultVarcharConfig)
      .notNull()
      .references(() => Users.id),
    leagueId: varchar("league_id", idConfig)
      .notNull()
...
export const LeagueTeamPlayers = pgTable(
  ...
  {
    id: varchar("id", idConfig).primaryKey(),
    leaguePlayerId: varchar("league_player_id", idConfig)
      .notNull()
      .references(() => LeaguePlayers.id),
    teamId: varchar("team_id", idConfig)
      .notNull()
...
export const SeasonFixtures = pgTable("season_fixture", {
  ...
  seasonId: varchar("season_id", idConfig)
    .notNull()
    .references(() => Seasons.id),
  matchId: varchar("match_id", idConfig).references(() => Matches.id),
  homePlayerId: varchar("home_player_id", idConfig)
    .notNull()
    .references(() => SeasonPlayers.id),
  awayPlayerId: varchar("away_player_id", idConfig)
    .notNull()
    .references(() => SeasonPlayers.id),
  createdAt: timestamp("created_at").notNull().defaultNow(),
  updatedAt: timestamp("updated_at").notNull().defaultNow(),
...
export const MatchTeams = pgTable(
  ...
  {
    id: varchar("id", idConfig).primaryKey(),
    seasonTeamId: varchar("season_team_id", idConfig)
      .notNull()
      .references(() => SeasonTeams.id),
    matchId: varchar("match_id", idConfig)
      .notNull()
...
export const MatchPlayers = pgTable(
  ...
  {
    id: varchar("id", idConfig).primaryKey(),
    seasonPlayerId: varchar("season_player_id", idConfig)
      .notNull()
      .references(() => SeasonPlayers.id),
...
export const LeagueInvites = pgTable(
  "league_invite",
  {
    ...
    code: varchar("code", idConfig).notNull(),
...
export const Users = pgTable("user", {
  ...
  defaultLeagueId: varchar("default_league_id", idConfig).references(() => Leagues.id),
  createdAt: timestamp("created_at").notNull().defaultNow(),
  updatedAt: timestamp("updated_at").notNull().defaultNow(),
});
